...
srun -N 1 -C cpu -t 04:00:00 --qos interactive --account desi python ./plot_chain_pmn.py --path2config config/lrg_z0_test_fnl100.yaml > output/y3wpxi02_fnl100_pmn.txt 2>&1


### QSO

# srun -N 1 -C cpu -t 04:00:00 --qos interactive --account desi python ./plot_chain_pmn.py --path2config  config/QSO_z0_test_prior.yaml > output/y3_QSO_wpxi02_pmn.txt 2>&1

# srun -N 1 -C cpu -t 04:00:00 --qos interactive --account desi python ./plot_chain_pmn.py --path2config  config/QSO_z0_test_vsmear.yaml > output/y3_QSOvsmear_wpxi02_pmn.txt 2>&1
