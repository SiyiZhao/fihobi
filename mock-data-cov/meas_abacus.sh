...
# pdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/mocks/Abacus_pngbase_c300_ph000/z2.000/galaxies_rsd_dv
...
config2Abacus=../hod-variation/configs/QSO-fnl30/z1_base-dv.yaml
