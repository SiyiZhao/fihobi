...
## B
names = ['QSO-z1_fNL100_base-dv', 'QSO-z1_fNL100_base-B-dv',
         'QSO-z6_fNL100_base-dv', 'QSO-z6_fNL100_base-B-dv']
labels=['z=0.95, base', 'z=0.95, base-B', 'z=3.0, base', 'z=3.0, base-B']
colors=[color[1], color[2], color[3], color[5]]
fn_out='out/compare_B_qso_fnl100_base_dv.png'
