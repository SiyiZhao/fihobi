...
def compare_chain(fn_all, labels=['chain1', 'chain2'], colors=['red', 'blue'], contour_ls=['-', '-'], markers={'p':1.0}, fn_out=None):
    ...
    g.triangle_plot(samples_all, params=['p', 'b1', 'sn0', 'sigmas'], markers=markers, legend_labels=labels, legend_loc='upper right', filled=False, contour_colors=colors, contour_ls=contour_ls)
    if fn_out:
