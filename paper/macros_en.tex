\usepackage[width=170mm, margin=1in]{geometry} % set the page layout
\usepackage{amsthm}
\usepackage{amsmath}
...
%%%%%%%%% cosmology %%%%%%%%%
\newcommand{\zeff}{z_{\mathrm{eff}}} % effective redshift
%%%%%%%%% vectors %%%%%%%%%
\newcommand{\vk}{\vb*{k}}
\newcommand{\vx}{\vb*{x}}
\newcommand{\vs}{\vb*{s}}
...
%%%%%%%%% env: todo %%%%%%%%%
\newmdenv[backgroundcolor=blue!12,hidealllines=true]{mytodo}
