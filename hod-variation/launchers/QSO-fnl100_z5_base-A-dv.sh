...
#SBATCH --job-name=QSO-fnl100_z5_base-A-dv
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/loa-v2_HODv1/QSO-fnl100/z5_base-A-dv/
mkdir -p $outdir
config=configs/QSO-fnl100/z5_base-A-dv.yaml
