...
#SBATCH --job-name=QSO-fnl100_z2_base-A-dv
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/loa-v2_HODv2/QSO-fnl100/z2_base-A-dv/
mkdir -p $outdir
config=configs/QSO-fnl100/z2_base-A-dv.yaml
