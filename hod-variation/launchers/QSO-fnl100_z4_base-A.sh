...
#SBATCH --job-name=QSO-fnl100_z4_base-A
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/loa-v2_HODv3/QSO-fnl100/z4_base-A/
mkdir -p $outdir
config=configs/QSO-fnl100/z4_base-A.yaml
