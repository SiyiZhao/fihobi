...
#SBATCH --job-name=LRG-fnl100_z1_base-A
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/loa-v2_HODv4/LRG-fnl100/z1_base-A/
mkdir -p $outdir
config=configs/LRG-fnl100/z1_base-A.yaml
