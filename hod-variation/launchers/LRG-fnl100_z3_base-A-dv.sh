...
#SBATCH --job-name=LRG-fnl100_z3_base-A-dv
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/loa-v2_HODv2/LRG-fnl100/z3_base-A-dv/
mkdir -p $outdir
config=configs/LRG-fnl100/z3_base-A-dv.yaml
