...
#SBATCH --job-name=QSO-fnl100_z5_base-A
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/loa-v2_HODv3/QSO-fnl100/z5_base-A/
mkdir -p $outdir
config=configs/QSO-fnl100/z5_base-A.yaml
