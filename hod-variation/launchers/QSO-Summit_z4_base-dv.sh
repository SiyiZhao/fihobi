...
#SBATCH --job-name=QSO-Summit_z4_base-dv
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/QSO-Summit/z4_base-dv/
mkdir -p $outdir
config=configs/QSO-Summit/z4_base-dv.yaml
...
srun -n 4 -c 128 python scripts/run_pmn.py --config $config > $outdir/run.log 2>&1
