...
#SBATCH --job-name=QSO-fnl100_z6_base-A
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/loa-v2_HODv3/QSO-fnl100/z6_base-A/
mkdir -p $outdir
config=configs/QSO-fnl100/z6_base-A.yaml
