...
#SBATCH --job-name=LRG-fnl100_z2_base-A
...
outdir=/pscratch/sd/s/siyizhao/desi-dr2-hod/loa-v2_HODv3/LRG-fnl100/z2_base-A/
mkdir -p $outdir
config=configs/LRG-fnl100/z2_base-A.yaml
