...
def plot_HOD_stat(samples, weights, path=None, logMcut=None, want_centers=True, want_sat=True, want_tot=True):
    ...
    if path is not None:
        ...
        print(f'Saved HOD figure to {path}')
    else:
        plt.show()
        print('No path provided, not saving the figure.')
    return fig, ax
