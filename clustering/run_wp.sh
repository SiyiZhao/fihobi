...
srun -N 1 -C gpu -t 04:00:00 --gpus 4 --qos interactive --account desi_g python pcforfit.py --dir $outdir --fix LRG_GCcomb_0.6_0.8_pip_angular_bitwise_log_njack128_nran4_split20 --mode wp --check > $outdir/wpforfit_stdout.log 2> $outdir/wpforfit_stderr.log
